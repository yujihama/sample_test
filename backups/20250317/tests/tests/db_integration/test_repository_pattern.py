...
def test_audit_procedure_repository():
    ...
    try:
        ...
        test_data = {
            ...
            "risk_areas": json.dumps(["財務", "コンプライアンス"]),
            "required_data_fields": json.dumps(["id", "amount", "date"]),
        }
...
def test_sample_data_repository():
    ...
    try:
        ...
        test_data = {
            ...
            "row_count": 100,
            "column_count": 5,
            "columns": json.dumps(["id", "name", "amount", "date", "status"]),
            "file_metadata": json.dumps({"encoding": "utf-8", "delimiter": ","}),
        }
