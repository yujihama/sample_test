...
def run_smoke_tests(verbose: bool = False, filter_str: Optional[str] = None, marker: Optional[str] = None) -> bool:
    """
    疎通テストを実行
...
def main():
    ...
    parser.add_argument("-m", "--marker", help="指定したマーカーを持つテストのみを実行します（例: smoke, workflow, api）")
    ...
    success = run_smoke_tests(args.verbose, args.filter, args.marker)
